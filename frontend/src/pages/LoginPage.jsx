...
// //           <h1 className="text-3xl font-bold text-gray-900 mb-2">Smart Campus</h1>
// //           <p className="text-lg text-blue-600 font-medium">Operations Hub</p>
// //           <p className="text-gray-500 mt-3 text-sm">
// //             Manage facilities, bookings, and maintenance tickets all in one place.
// //           </p>
// //         </div>
...
// //               <p className="text-xs text-gray-500 mt-1">Manage Facilities</p>
// //             </div>
// //             <div>
// //               <div className="text-2xl">📅</div>
// //               <p className="text-xs text-gray-500 mt-1">Book Resources</p>
// //             </div>
// //             <div>
// //               <div className="text-2xl">🔧</div>
