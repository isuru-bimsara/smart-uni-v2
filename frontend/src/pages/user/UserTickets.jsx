...
//       {/* ---- Create Ticket Form ---- */}
//       <form onSubmit={handleSubmit} className="mb-8 bg-gray-50 p-4 rounded shadow">
...
//         </div>
//         <div className="mb-3">
//           <label className="block mb-1">Add up to 3 images:</label>
//           <input
//             type="file"
//             multiple
//             accept="image/*"
...
//                       // Try absolute path if needed, e.g. `/uploads/tickets/filename.jpg`
//                       <img
//                         key={idx}
